...
const CountrySelector: React.FC = () => {
  ...
  const handleCountrySelect = (event: any, country: any | null) => {
    console.log("Selected Country Object:", country); // Log the selected country object
    ...
    const code = country
      ? countryCodes.find((c) => c.callingCode === country.calling_code)
          ?.isoCode || null
      : null; // Получаем ISO-код
    console.log("Selected ISO Code:", code); // Log the ISO code
              ...
              <Autocomplete
                ...
                renderOption={(props, option) => {
                  ...
                  return (
                    <Box
                      component="li"
                      key={optionKey} // Pass the key directly to Box
